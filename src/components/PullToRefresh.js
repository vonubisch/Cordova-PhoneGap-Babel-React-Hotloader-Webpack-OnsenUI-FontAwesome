...
class PullToRefresh extends React.Component {
    ...
    renderToolbar() {
        return (
            <Toolbar>
                <div className="left">
                    <BackButton icon="fa-arrow-right">Back</BackButton>
                </div>
    ...
    render() {
        ...
        return (
            <Page renderToolbar={this.renderToolbar}>
                ...
                <List dataSource={this.state.data} renderHeader={() => <ListHeader>Pull down to refresh</ListHeader>} renderRow={this.renderRow}/>
            </Page>
        );
    }
}
