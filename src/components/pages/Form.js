    ...
    render() {
        return (
            <Page>
                ...
                <List form>
                    {[1, 2, 3].map(n => {
                        return (<ListItem checkbox key={n} name="my-checkbox" value={n} title={`Checkbox ${n}`}/>);
                    })
}
                </List>
                ...
                <List form>
                    {[1, 2, 3].map(n => {
                        return (<ListItem radio key={n} name="my-radio" checked={n === this.state.radioSelected} value={n} title={`Radio ${n}`} onChange={() => {
                ...
                <ContentBlock inner>
                    ...
                    <GridRow style={pStyle}>
                        <GridCol>
                            <Button big fill color="green">Send</Button>
                        </GridCol>
                        <GridCol>
                            <Button big fill color="red">Delete</Button>
                        </GridCol>
                    </GridRow>
                    <GridRow style={pStyle}>
                        <GridCol>
                            <Button fill raised color="green">Raised</Button>
                        </GridCol>
                        <GridCol>
                            <Button raised color="red">Raised</Button>
                        </GridCol>
                        <GridCol>
                            <Button fill raised color="pink">Raised</Button>
                        </GridCol>
                    </GridRow>
                </ContentBlock>
            </Page>
